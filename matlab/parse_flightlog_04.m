function status = parse_flightlog_04(varargin)
...
function parse_data_line(theline)
  ...
  %need r3evisions
	...
	%DATA[0, 0, [0,0,0], [0.000000, 0.000000, 0.000000], 0, [0.000000, 0.000000, 0.000000], [0.000000, 0.000000, 0.000000], [0.000000, 0.000000, 0.000000], [0, 0, 0]]
...
% Parse the string into the struct
  [flight_log_data.rover_t(flight_log_data.idx, 1), ...
   ...
   flight_log_data.rover_m_thrust(flight_log_data.idx, 4)] = ...
    strread(theline, 'DATA[%u %u [%n%n%n] [%n%n%n] [%n %n %n] %d [%n %n %n] [%n %n %n] [%n %n %n] [%n %n %n] [%n %n %n %n]]', 'delimiter', ',');
% end
